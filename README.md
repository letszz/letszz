...
### 👩‍💻 About Me
I'm a **System Analysis and Development (ADS)** student with a deep passion for the intersection of logic and aesthetics. I love building things that not only work perfectly but also look amazing.

- 🎓 Currently pursuing my degree in **System Analysis and Development**.
- 🎨 Strongly interested in **Web Design, UI/UX, and Mobile Development**.
- 🚀 Always exploring new ways to create seamless user experiences.
- 🐍 Currently diving deep into **Python** to expand my backend and logic skills.
